...
<head>
    ...
    <title>Fuel Sales - WinFuel Dashboard</title>
                    ...
                    <div class="modal-body">
                        <section class="container" id="container">
                            <form action="staff/fuelSales" method="post" class="form">
                                ...
                                <div class="input-box">
                                    <label>Amount :
                                        <input type="number" placeholder="" name="amount" step="0.01" min="0.1"
                                               max="${fuel1.amount}" id="fuelAmountInput"> </label>
                                    <div class="modal" id="requestModal" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <section class="container" id="container">
                                                        <form action="staff/fuelSales" method="post" class="form">
                                                            <div class="input-box">
                                                                <label>Fuel Type :
                                                                    <input type="text" name="fuelName" required readonly
                                                                           id="fuelName">
                                                                </label>
                                                            </div>
                                                            <div class="input-box">
